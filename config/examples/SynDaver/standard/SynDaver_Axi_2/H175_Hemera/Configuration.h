...
#define PIDTEMPBED // <-- changed
  ...
  #define DEFAULT_BED_KP  286.02 // <-- changed
  #define DEFAULT_BED_KI   54.55 // <-- changed
  #define DEFAULT_BED_KD 374.9 // <-- changed
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {37.89,38.25,-4.6} // <-- changed: (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define USB_DEVICE_PRODUCT_NAME "SynDaverAxi2" // <-- changed
...
#define TOUCH_UI_VERSION "Release: 3 (" __DATE__  ")\nMarlin " SHORT_BUILD_VERSION // <-- changed
