 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {43.5,23.75,-2.35} // <-- changed: (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define USB_DEVICE_PRODUCT_NAME "SynDaver Axi" // <-- changed
...
#define TOUCH_UI_VERSION "Release: 7 (" __DATE__  ")\nMarlin " SHORT_BUILD_VERSION // <-- changed
