...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  55.64 // <-- changed
    #define DEFAULT_KI   6.79 // <-- changed
    #define DEFAULT_KD 113.94 // <-- changed
  #endif
#else
 ...
 */
#define DEFAULT_ACCELERATION          250    // <-- changed: X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  3000    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   250    // <-- changed: X, Y, Z acceleration for travel (non printing) moves
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 289.5 // <-- changed
...
#define TOOLHEAD_NAME "MOARstruder" // <-- changed
#define TOOLHEAD_TYPE "MOARstruder" // <-- changed
...
#define USB_DEVICE_PRODUCT_NAME "TAZ 5       " // <-- changed
