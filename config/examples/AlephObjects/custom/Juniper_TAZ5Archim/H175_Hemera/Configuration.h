...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_KP  22.89 // <-- changed
    #define DEFAULT_KI   2.55 // <-- changed
    #define DEFAULT_KD 51.27 // <-- changed
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,1600,400} // <-- changed
...
#define Y_BED_SIZE 275.4 // <-- changed

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS -2 // <-- changed
#define Z_MIN_POS 0
#define X_MAX_POS 299.5 // <-- changed
#define Y_MAX_POS 275.4 // <-- changed
...
#define NOZZLE_PARK_FEATURE // <-- changed
  ...
  #define NOZZLE_PARK_POINT {100,265.4,20} // <-- changed
...
#define TOOLHEAD_NAME "H175" // <-- changed
