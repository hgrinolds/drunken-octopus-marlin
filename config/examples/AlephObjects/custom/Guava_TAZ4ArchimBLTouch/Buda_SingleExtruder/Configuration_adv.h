 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS     8 // <-- changed: (°C)
  ...
  #define WATCH_TEMP_INCREASE 8               // <-- changed: (°C)
#endif
...
#define USE_CONTROLLER_FAN // <-- changed
  ...
  #define CONTROLLERFAN_SPEED_ACTIVE    130 // <-- changed: (0-255) Active speed, used when any motor is enabled
 ...
 */
#define INPUT_SHAPING_X // <-- changed
#define INPUT_SHAPING_Y // <-- changed
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // <-- changed: All axes (override below)
