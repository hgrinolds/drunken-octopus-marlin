...
#define PID_MAX  74      // <-- changed: Limit hotend current while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_KI   0.3 // <-- changed
    #define DEFAULT_KD 125 // <-- changed
  #endif
#else
  #define BANG_MAX 70    // <-- changed: Limit hotend current while in bang-bang mode; 255=full current
#endif
...
#define PIDTEMPBED // <-- changed
  ...
  #define DEFAULT_BED_KP  20 // <-- changed
  #define DEFAULT_BED_KI   5 // <-- changed
  #define DEFAULT_BED_KD 275 // <-- changed
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {-54,0,-4} // <-- changed: (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define XY_PROBE_FEEDRATE    3960 // <-- changed: (mm/min)
...
#define PROBE_OFFSET_XMIN -60   // <-- changed: (mm)
...
//#define PREHEAT_2_LABEL       "ABS" // <-- changed
//#define PREHEAT_2_TEMP_HOTEND 240 // <-- changed
//#define PREHEAT_2_TEMP_BED    110 // <-- changed
//#define PREHEAT_2_TEMP_CHAMBER 35 // <-- changed
//#define PREHEAT_2_FAN_SPEED     0 // <-- changed: Value from 0 to 255
...
#define USB_DEVICE_PRODUCT_NAME "TAZ 4       " // <-- changed
