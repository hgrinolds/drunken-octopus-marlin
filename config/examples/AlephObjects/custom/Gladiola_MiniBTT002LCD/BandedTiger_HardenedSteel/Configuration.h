...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_BTT002_V1_0 // <-- changed
#endif
 ...
 */
#define SERIAL_PORT_2 3 // <-- changed
 ...
 */
#define X_DRIVER_TYPE  TMC2209 // <-- changed
#define Y_DRIVER_TYPE  TMC2209 // <-- changed
#define Z_DRIVER_TYPE  TMC2209 // <-- changed
...
#define E0_DRIVER_TYPE TMC2209 // <-- changed
...
#define PIDTEMPBED // <-- changed
  ...
  #define DEFAULT_BED_KP  294 // <-- changed
  #define DEFAULT_BED_KI   65 // <-- changed
  #define DEFAULT_BED_KD 382 // <-- changed
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {0,0,-1.38} // <-- changed: (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
