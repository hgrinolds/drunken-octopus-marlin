...
#define LIN_ADVANCE // <-- changed
    ...
    #define ADVANCE_K {0,0}    // <-- changed: (mm) Compression length per 1mm/s extruder speed, per extruder. Override with 'M900 T<tool> K<mm>'.
  #else
    #define ADVANCE_K {0,0}        // <-- changed: (mm) Compression length for all extruders. Override with 'M900 K<mm>'.
  #endif
 ...
 */
  ...
  #define PROBING_MARGIN_RIGHT 5 // <-- changed
