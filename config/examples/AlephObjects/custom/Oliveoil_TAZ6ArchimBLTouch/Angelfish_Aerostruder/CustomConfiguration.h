...
#define STRING_CONFIG_H_AUTHOR "(Drunken Octopus Marlin)" // <-- changed: Original author or contributor.
...
#define HEATER_0_MAXTEMP 285 // <-- changed
...
#define PIDTEMPBED // <-- changed
  ...
  #define DEFAULT_BED_KP  162 // <-- changed
  #define DEFAULT_BED_KI   17 // <-- changed
  #define DEFAULT_BED_KD 378 // <-- changed
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {0,-22,-2.35} // <-- changed: (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
...
#define Z_CLEARANCE_FOR_HOMING  15   // <-- changed: (mm) Minimal Z height before homing (G28) for Z clearance above the bed, clamps, ...
 ...
 */
#define PREHEAT_BEFORE_LEVELING  // <-- changed by hrg
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 10              // <-- changed: Set Mesh bounds as an inset region of the bed
  #define GRID_MAX_POINTS_X 10     // <-- changed: Don't use more than 15 points per axis, implementation limited.
