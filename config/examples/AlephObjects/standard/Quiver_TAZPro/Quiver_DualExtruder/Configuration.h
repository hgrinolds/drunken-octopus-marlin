...
#define SWITCHING_NOZZLE // <-- changed
  ...
  #define SWITCHING_NOZZLE_SERVO_ANGLES {{55,120},{55,120}}   // <-- changed: A pair of angles for { E0, E1 }.
                                                    // For Dual Servo use two pairs: { { lower, raise }, { lower, raise } }
  #define SWITCHING_NOZZLE_SERVO_DWELL 2500         // Dwell time to wait for servo to make physical move
  //#define SWITCHING_NOZZLE_LIFT_TO_PROBE            // <-- changed: Lift toolheads out of the way while probing
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET {0,0,-1.1} // <-- changed: (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
