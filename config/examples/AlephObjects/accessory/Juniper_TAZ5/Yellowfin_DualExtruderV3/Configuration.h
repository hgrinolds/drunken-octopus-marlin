...
#define X_BED_SIZE 278.5 // <-- changed
#define Y_BED_SIZE 270.4 // <-- changed

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -6 // <-- changed
#define Y_MIN_POS -7 // <-- changed
#define Z_MIN_POS 0
#define X_MAX_POS 278.5 // <-- changed
#define Y_MAX_POS 270.4 // <-- changed
...
#define NOZZLE_PARK_FEATURE // <-- changed
  ...
  #define NOZZLE_PARK_POINT {100,260.4,20} // <-- changed
