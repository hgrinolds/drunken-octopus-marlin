...
#define X_BED_SIZE 287.5 // <-- changed
#define Y_BED_SIZE 276.4 // <-- changed

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS -7 // <-- changed
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 287.5 // <-- changed
#define Y_MAX_POS 276.4 // <-- changed
...
#define NOZZLE_PARK_FEATURE // <-- changed
  ...
  #define NOZZLE_PARK_POINT {100,266.4,20} // <-- changed
...
#define TOOLHEAD_NAME "Flexystruder" // <-- changed
#define TOOLHEAD_TYPE "Flexystruder" // <-- changed
