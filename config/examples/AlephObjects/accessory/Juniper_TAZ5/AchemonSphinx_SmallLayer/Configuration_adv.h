...
#define DIGIPOT_MOTOR_CURRENT {175,175,240,177,177}   // <-- changed: Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
...
//#define DISABLE_REDUCED_ACCURACY_WARNING
  ...
  #define MANUAL_FEEDRATE {3000,3000,240,42} // <-- changed: (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
