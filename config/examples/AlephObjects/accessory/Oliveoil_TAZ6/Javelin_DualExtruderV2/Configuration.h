 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,1600,830,830} // <-- changed
...
#define NOZZLE_CLEAN_FEATURE // <-- changed
  ...
  #define NOZZLE_CLEAN_START_POINT {{-17,95,1},{-17,95,1}} // <-- changed
  #define NOZZLE_CLEAN_END_POINT   {{-17,25,1},{-17,73,1}} // <-- changed
...
#define TOOLHEAD_NAME "Dual Extruder 2" // <-- changed
#define TOOLHEAD_TYPE "DualExtruder v2" // <-- changed
#define WIPE_SEQUENCE_COMMANDS "M117 Hot end heating...\nM104 S170 T0\nM104 S170 T1\nG28 O1\nM117 Wiping nozzle\nT0\nG1 X-17 Y25 Z10 F4000\nM109 R170 T0\nM109 R170 T1\nG1 Z1\nM114\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 X-17 Y25\nG1 X-17 Y95\nG1 Z15\nM400\nM106 S255\nG0 X-10 Y-9\nM109 R160 T0\nM109 R160 T1\nM107" // <-- changed
