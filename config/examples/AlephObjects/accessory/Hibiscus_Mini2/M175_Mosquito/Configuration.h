...
#define PIDTEMPBED // <-- changed
  ...
  #define DEFAULT_BED_KP  384.33 // <-- changed
  #define DEFAULT_BED_KI   72.17 // <-- changed
  #define DEFAULT_BED_KD 511.64 // <-- changed
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,200,415} // <-- changed
...
#define X_BED_SIZE 155.5 // <-- changed
...
#define Z_MIN_POS 0
#define X_MAX_POS 155.5 // <-- changed
